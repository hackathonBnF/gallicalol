<?php
  ...
  $url_query = 'http://gallica.bnf.fr/SRU?operation=searchRetrieve&version=1.2&maximumRecords=50&query=dc.type%20any%20image%20and%20gallica%20any%20"' . $_GET['query'] . '"';
