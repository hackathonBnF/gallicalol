...
<nav class="navbar navbar-light">
  ...
  <div class="nav navbar-inline float-xs-right">
    <a class="browse nav-link" href="/search.php">chercher</a>
...
<div class="row">
<div>
<form id="search" action="search_memes.php" method="post" class="form-inline">
  <div class="row">
	<div class="col-xs-10"><input type="text" id="query" name="query" class="form-control input-sm" maxlength="64" placeholder="Chercher un même" value="" /></div>
	<div class="col-xs-2"><button type="submit" class="btn btn-primary">chercher</button></div>
  </div>
</form>
<div id="memes" class="grid">
<?php
                       while( $meme = $result->fetchArray() ) {
?>
<div class="grid-item"><a href="/view.php?id=<?php echo $meme['id'] ?>"><img src="<?php echo $meme['image'] ?>" /></a></div>
<?php
                       }
?>
</div>
