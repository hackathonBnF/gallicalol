...
$url_query = 'http://gallica.bnf.fr/SRU?operation=searchRetrieve&version=1.2&query=dc.type%20any%20image%20and%20gallica%20any%20"' . urlencode(urldecode($_GET['query'])) . '"';
